...
function move()
    return {
        ...
        { map = "-23,32", changeMap = "bottom" }, 
        { map = "-23,33", changeMap = "bottom" }, 
        { map = "-23,34", changeMap = "left" }, 
        { map = "-24,34", changeMap = "left" }, 
        { map = "-20,34", changeMap = "right" }, 
        { map = "-19,34", changeMap = "right" }, 
        { map = "-18,34", changeMap = "right" }, 
        { map = "-24,37", changeMap = "right" }, 
        { map = "-23,37", changeMap = "right" }, 
        { map = "-22,37", changeMap = "right" }, 
        { map = "-21,37", changeMap = "right" }, 
        { map = "-20,37", changeMap = "top" }, 
        { map = "-20,36", changeMap = "top" }, 
        { map = "-20,35", changeMap = "top" }, 
        { map = "-17,34", changeMap = "top" }, 
        { map = "-17,33", changeMap = "top" }, 
        { map = "-17,32", changeMap = "top" }, 
        { map = "-17,31", changeMap = "left" }, 
